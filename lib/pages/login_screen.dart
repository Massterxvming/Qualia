...
class _LoginPageState extends State<LoginPage>with SingleTickerProviderStateMixin {
  // 定义状态类
  late TabController _tabController; // 定义TabControllers
  ...
  Widget build(BuildContext context) {
    ...
    // 决定当屏幕宽度小于600时是否使用Card和Padding
    bool useCardAndPadding = screenWidth >= 600;
    // 登录页面内容
    Widget content = Column(
      ...
      children: [
        ...
        SizedBox(
          height: screenWidth < 600 ? 480 : 380,
          child: TabBarView(
            controller: _tabController,
            physics: const NeverScrollableScrollPhysics(),
            children: [
              LoginForm(phoneNumberController: _phoneNumberControllerTab1),
              PhoneLoginForm(phoneNumberController: _phoneNumberControllerTab2),
            ],
          ),
        ),
      ],
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            children: [
              Checkbox(
                visualDensity: VisualDensity.adaptivePlatformDensity, // 视觉效果
